...
const Footer = () => {
  return (
    <div className="bg-black text-white">
      <Container>
        <footer className="footer sm:footer-horizontal grid grid-cols-5 justify-items-center p-10">
          <nav>
...
<a className="link link-hover flex items-center gap-2">
  <img 
    src ="https://www.bing.com/th/id/OIP.YiMfOIxX-2Mxz_utvZ86zwHaHa?w=197&h=211&c=8&rs=1&qlt=90&r=0&o=6&dpr=1.3&pid=3.1&rm=2" className="w-4 h-4 invert" 
    alt="X" 
  />
  @CS - Ticket System
</a>
